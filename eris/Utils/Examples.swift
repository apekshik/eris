...
let examplePost = Post(authorUserID: "", authorUsername: "madhansolo", recipientUserID: "", recipientUsername: "apekshik", imageURL: URL(string: "gs://fir-eris.appspot.com/TestImages/Apek1Large.jpeg"), caption: "", isParent: true, isConnected: true, hasChain: false, connectedPostID: "", connectedPostImageURL: URL(string: "gs://fir-eris.appspot.com/TestImages/Mad1Large.jpeg"), connectedPostCaption: "", createdAt: Date())
