...
let exampleLivePosts: [LivePost] = [
  ...
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "test live post 2 more flooding of text. Hmmm... What more could I write to make this longer? How about some more? Maybe even more? No, even more", authorUsername: "Ananya", anonymous: false),
  ...
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "test live post 1 gonna flood these with text to see the limits of the scroll view", authorUsername: "epicShit", anonymous: false),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "test live post 2 more flooding of text. Hmmm... What more could I write to make this longer? How about some more? Maybe even more?", authorUsername: "Ananya", anonymous: false),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "Test live post 3 just going to throw in some random shit", authorUsername: "Aniket", anonymous: false),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "Test live post 4. more random shit", authorUsername: "Dips", anonymous: true),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "Test live post 5. alittle more a little less. Just to test more", authorUsername: "Dips", anonymous: false),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "Test live post 6. Hommmm how about this? ", authorUsername: "epicShit", anonymous: false),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "test live post 1 gonna flood these with text to see the limits of the scroll view", authorUsername: "epicShit", anonymous: false),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "test live post 2 more flooding of text. Hmmm... What more could I write to make this longer? How about some more? Maybe even more?", authorUsername: "Ananya", anonymous: false),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "test live post 3", authorUsername: "Aniket", anonymous: false),
  LivePost(userID: "", authorID: "", selfID: "", createdAt: Date(), text: "test live post 4", authorUsername: "Dips", anonymous: true),
