...
//
//  Under MIT License
//  Source: https://github.com/rorodriguez116/Camera-SwiftUI.git
...
extension Photo {
    ...
    public var thumbnailData: Data? {
        ImageResizer(targetWidth: 100).resize(data: originalData)?.jpegData(compressionQuality: 0.3)
    }
...
public class CameraService: NSObject, Identifiable {
    ...
    private func configureSession() {
        ...
        if session.canAddOutput(photoOutput) {
            ...
            // TODO: Remove Depracation warnings for this
