...
//  Explanation and Details - https://betterprogramming.pub/effortless-swiftui-camera-d7a74abde37e 
...
// MARK: [Camera Service Class Starts Here]
public class CameraService {
  typealias PhotoCaptureSessionID = String
  
  //  MARK: Observed Properties UI must react to
  
  //  Tells observers whether the flash is turned ON or OFF.
  @Published public var flashMode: AVCaptureDevice.FlashMode = .off
  //  Tells observers whether the UI should show an alert view or not.
  @Published public var shouldShowAlertView = false
  //  Tells observers whether the UI should show a spinner indicating
  //  that work is going on to process the captured photo.
  @Published public var shouldShowSpinner = false
  //  Tells observers when a photo is about to be captured. Ideal for
  //  flashing the screen or playing an animation just before capturing the shot.
  @Published public var willCapturePhoto = false
  //  Self-explanatory. We start with value set to false, and once we configure
  //  the camera session successfully, we will set the value to true.
  @Published public var isCameraButtonDisabled = true
  //  Self-explanatory. We start with value set to false, and once we configure
  //  the camera session successfully, we will set the value to true.
  @Published public var isCameraUnavailable = true
  //  The photo output. The struct Photo in this case is pretty simple. Once the
  //  photo has been captured and processed, observers will receive a new value.
  ...
  private func configureSession() {
    ...
    if session.canAddOutput(photoOutput) {
      ...
      // TODO: isHighResolutionCaptureEnabled is Depracated. Come back and fix this later.
  ...
  public func capturePhoto() {
    if self.setupResult != .configurationFailed {
      ...
      sessionQueue.async {
        ...
        // Come back to this later to fix depracation issues.
        //        photoSettings.maxPhotoDimensions = CMVideoDimensions(width: <#T##Int32#>, height: <#T##Int32#>)
